...
const initialState: DJControllerState = {
  ...
  effect: { fxSelect: false, beatLeft: false, beatRight: false, levelDepth: 0, fxOn: false, chSelect: 'None' },
  browse: { rotaryTurn: 0, rotaryPush: false, load1: false, load2: false },
  lastMessage: null,
}
